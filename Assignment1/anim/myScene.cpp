...
void MakeScene(void)
{
	...
	*/
	...
	//SampleForceSimulator* forceSimulator =
		//new SampleForceSimulator( "force", sphere1 );

	//success = GlobalResourceManager::use()->addSimulator(forceSimulator );
	...
	//sampleSimulatorRetrieval = 
		//GlobalResourceManager::use()->getSimulator( "force" );
