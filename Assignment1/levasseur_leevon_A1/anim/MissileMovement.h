#ifndef MY_MISSILE_MOVEMENT_H
#define MY_MISSILE_MOVEMENT_H
...
class MissileMovement : public BaseSimulator
{
public:

	MissileMovement(const std::string& name, BaseSystem* target);
	~MissileMovement();
